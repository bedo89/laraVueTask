            ...
            <div class="d-block">
                <form v-on:submit.prevent="createProduct">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="productData.name" class="form-control" id="name" placeholder="Enter product name" required>
                        <div class="invalid-feedback" v-if="errors.name">{{errors.name[0]}}</div>
                    </div>
                    <div class="form-group">
                        <label for="price">Enter Price</label>
                        <input type="text" v-model="productData.price" class="form-control" id="price" placeholder="Enter product price" required>
                        <div class="invalid-feedback" v-if="errors.price">{{errors.price[0]}}</div>
                    </div>
                    <div class="form-group">
                        <label for="description">Enter Description</label>
                        <input type="text" v-model="productData.description" class="form-control" id="description" placeholder="Enter product description" style="min-height: 60px;" required>
        ...
        <b-modal ref="editProductModal" hide-footer title="Update Product">
            <div class="d-block">
                <form v-on:submit.prevent="updateProduct">
                    <div class="form-group">
                        <label for="name">Enter Name</label>
                        <input type="text" v-model="editProductData.name" class="form-control" id="name" placeholder="Enter product name" required>
                        <div class="invalid-feedback" v-if="errors.name">{{errors.name[0]}}</div>
                    </div>
                    <div class="form-group">
                        <label for="price">Enter Price</label>
                        <input type="text" v-model="editProductData.price" class="form-control" id="price" placeholder="Enter product price" required>
                        <div class="invalid-feedback" v-if="errors.price">{{errors.price[0]}}</div>
                    </div>
                    <div class="form-group">
                        <label for="description">Enter Description</label>
                        <input type="text" v-model="editProductData.description" class="form-control" id="description" placeholder="Enter product description" style="min-height: 60px;" required>
                        <div class="invalid-feedback" v-if="errors.price">{{errors.description[0]}}</div>
                    </div>
                    <div class="form-group">
                        <label for="image">Choose an image</label>
                        <div>
